...
abbr --add gtr 'git tag --sort=-creatordate --format="%(refname:short) [%(creatordate:short)] %(objectname:short)" | head'
abbr --add gt 'git tag --sort=-v:refname --format="%(refname:short) [%(creatordate:short)] %(objectname:short)" | head'
abbr --add gu 'gitui'
...
abbr --add ks 'kubectl_context_switch'
...
abbr --add ows 'oxen workspace status'
abbr --add os 'fuzzy-oxen-worktree'
